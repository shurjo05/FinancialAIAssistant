...
## 18. Making a silent fallback observable (and hardening the agent loop)
...
## 19. Closing the ML loop: corrections as versioned training signal
...
## 20. A model-regression gate in CI (without retraining every commit)
...
## 21. Security pass: revocable JWTs, rate limits, and triaging a scanner finding
